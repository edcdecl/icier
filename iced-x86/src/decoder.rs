...
#[rustfmt::skip]
#[cfg(any(feature = "__internal_flip", feature = "evex", not(feature = "no_vex"), not(feature = "no_xop"), feature = "mvex"))]
...
impl<'a> Decoder<'a> {
	...
	#[cfg(not(any(feature = "evex", feature = "mvex")))]
	...
	#[inline(always)]
	#[cfg(any(feature = "evex", not(feature = "no_vex"), not(feature = "no_xop"), feature = "mvex"))]
